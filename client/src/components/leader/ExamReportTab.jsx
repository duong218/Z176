  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-xl font-bold text-white">Thống kê theo Bài thi</h2>
          <p className="text-sm text-slate-400">Chi tiết số lượng thí sinh, lượt thi và tỷ lệ đạt theo từng bài thi / chủ đề</p>
        </div>
        <button
                ...
                <tr>
                  <td colSpan={8} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center text-slate-500">
                      ...
                      <p className="text-base font-medium text-slate-400">Chưa có thống kê theo bài thi</p>
                      <p className="text-sm mt-1">Hiện chưa có dữ liệu kết quả thi để thống kê theo bài thi.</p>
                    </div>
                  </td>
                </tr>
              ) : (
                  ...
                  <tr key={item._id} className="hover:bg-slate-700/30 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-white">{item.examTitle}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-slate-400">{item.topicName}</td>
